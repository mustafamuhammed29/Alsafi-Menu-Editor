...
export const BifoldPanel2InsideLeft = ({ panelData }) => {
  ...
  return (
    <div className="a4-page-wrapper" id="bifold-panel-2">
      <div
      ...
      >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="font-cinzel text-xs font-black text-brand-gold tracking-wider uppercase block">
                ALSAFI SPEISEKARTE · SEITE 1
              </span>
              <span className="text-[8.5px] text-gray-300">FRÜHSTÜCK · MEZZE · VORSPEISEN · SALATE · BOXEN</span>
            </div>
          </div>
        ...
        {/* ─── CATEGORIES 1 TO 6 GRID (LARGER SPACIOUS FONTS) ────────────────────────── */}
...
export default BifoldPanel2InsideLeft;
