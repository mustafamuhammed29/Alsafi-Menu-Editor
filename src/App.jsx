...
const MenuEditorContent = () => {
  const { pages, getEffectiveSettingsForPage } = useMenu();
  ...
  return (
    <div className="min-h-screen pt-24 pb-20 bg-[#141414] flex print:p-0 print:m-0 print:min-h-0 print:bg-[#050a07] print:block selection:bg-brand-gold selection:text-black">
      ...
      {/* Main A4 Document Canvas Container */}
      <main className="flex-1 flex flex-col items-center gap-12 ml-[460px] print:ml-0 print:p-0 print:m-0 print:gap-0 print:block print:w-[210mm] no-print:ml-[460px]">
        {pages.map((page, idx) => (
          <A4Page
            key={page.id}
            pageData={page}
