export const DEFAULT_COVER_PAGE = {
  ...
  layout: 'cover',
  isCover: true,
  coverStyle: 'full-photo-hero',
  header: {
    badge: 'ORIENTALISCHE GASTRONOMIE SEIT 2018 · HEIDELBERG',
    title: 'ALSAFI RESTAURANT',
    subtitle: '✦ SPEISEKARTE · EINE KULINARISCHE REISE DES ORIENTS ✦',
    tagline: 'SCHAWARMA · HOLZKOHLEGRILL · MEZZE · WRAPS',
  },
  coverBadgeSize: 9.5,
  coverTitleSize: 34,
  coverSubtitleSize: 11.5,
  coverTaglineSize: 9,
  coverLogoSize: 68,
  coverFooterTitleSize: 8,
  coverFooterValueSize: 9.5,
  coverFooterWrap: true,
  coverHeroImage: '/dishes/dish2-kebab.jpg',
  coverHeroScale: 1.05,
  coverHeroPosX: 50,
  coverHeroPosY: 50,
  coverHeroDarkness: 10,
  coverHeroBrightness: 100,
  coverHeroContrast: 100,
  coverHeroVignette: 35,
  contactInfo: {
    phone: '06221 72 59 000',
    address: 'Hertzstraße 1, 69126 Heidelberg – Kaufland',
    hours: 'Montag–Samstag 11:00–22:00 Uhr | Sonntag & Feiertage 12:00–22:00 Uhr',
    delivery: 'Lieferando · Uber Eats · Wolt',
    email: 'info@alsafi-heidelberg.de',
  },
  pillars: [
    { title: '100% Halal', desc: 'Zertifiziert & rein' },
    { title: 'Holzkohlegrill', desc: 'Echtes Raucharoma' },
    { title: 'Täglich frisch', desc: 'Hausgemachte Dips' },
    { title: 'Gastfreundschaft', desc: 'Ahlan Wa Sahlan' },
  ],
  categories: []
};
    ...
    categories: [
      {
        ...
        items: [
          { num: '1', name: 'Shakshuka 🥬', badge: '★ BELIEBT', allergens: 'Allergene: C, I', desc: 'Rührei in aromatischer Tomatensoße mit Zwiebeln, Paprika, Knoblauch und frischer Petersilie.', price: '10,90 €' },
          ...
          { num: '6', name: 'Alsafi Frühstücksplatte 🥬', allergens: 'Allergene: A, G, I, K', desc: 'Falafeln, gegrillter Halloumi, Fetakäse, Rakak bil Jibin, Hummus, Rote-Bete-Creme, arabischer Frischkäse, Tomaten, Gurken, Oliven und frische Minze.', price: '14,90 €' },
        ]
      }
    ],
    bottomCallout: {
    ...
    categories: [
      {
        ...
        items: [
          ...
          { num: '12', name: 'Muhammara 🌱🌶️', allergens: 'Allergene: A, H, K', desc: 'Würzige Paprika-Creme mit Zwiebeln, Sesam und Olivenöl, garniert mit Walnüssen.', price: '5,90 €' },
          ...
          { num: '15', name: 'Hummus bil Lahm', badge: '★ BELIEBT', allergens: 'Allergene: H, K', desc: 'Cremiger Hummus mit gegrilltem Kalbfleisch, Olivenöl und gerösteten Nüssen.', price: '12,90 €' },
          { num: '16', name: 'Alsafi Mezze Teller 🥬', allergens: 'Allergene: A, C, K, L', desc: 'Hummus, Toum, Baba Ghanoush, Muhammara und Rote-Bete-Creme, dazu cremiger Weißkohlsalat, eingelegte Gurken und weiße Rüben.', price: '14,90 €' }
        ]
      },
      {
        id: 'c3',
        ...
        items: [
          { num: '20', name: 'Kufta bil Khuboz', badge: '★ BELIEBT', allergens: 'Allergene: A, K', desc: 'Würziges Kalb- und Lammhackfleisch mit Zwiebeln, Petersilie und Sumach im arabischen Fladenbrot, knusprig gebacken und mit Hummus serviert.', price: '8,90 €' },
    ...
    categories: [
      {
        ...
        items: [
          ...
          { num: '31', name: 'Falafel, 3 Stück 🌱', badge: '★ BELIEBT', allergens: 'Allergene: I, K', desc: 'Hausgemachte Falafeln aus Kichererbsen, frischen Kräutern und Gewürzen, dazu Hummus und Sesampaste.', price: '4,90 €' },
    ...
    categories: [
      {
        ...
        items: [
          ...
          { num: '45', name: 'Alsafi Salat', badge: '★ BELIEBT', allergens: 'Allergene: G, I, L', desc: 'Gemischter Salat mit gegrilltem Kalbfleisch, Tomaten, eingelegten Gurken, Paprika, Zwiebeln und Mais, dazu Joghurtdressing.', price: '13,90 €' },
          ...
          { num: '47', name: 'Gemischter Salat 🥬', allergens: 'Allergene: G, I, L', desc: 'Knackiger gemischter Salat mit Tomaten, Paprika, Radieschen, Zwiebeln und hausgemachtem Dressing.', price: '7,90 €' }
        ]
      }
    ]
  },
    ...
    categories: [
      {
        ...
        items: [
          ...
          { num: '55', name: 'Yamir Box', badge: '★ BELIEBT', allergens: 'Allergene: A, C, G, K, L', desc: 'Klein geschnittene, knusprig panierte Hähnchenbruststreifen mit cremigem Weißkohlsalat, Tomaten, eingelegten Gurken, Toum und hausgemachter Soße, wahlweise mit Pommes oder gemischtem Salat.', price: '9,50 €' }
        ]
      }
    ],
    bottomCallout: {
    ...
    categories: [
      {
        ...
        items: [
          ...
          { num: '68', name: 'Mehdi Crispy', badge: '★ BELIEBT', allergens: 'Allergene: A, C, G, K, L', desc: 'Knusprig panierte Hähnchenbruststreifen mit Salat, cremigem Weißkohlsalat und eingelegten Gurken, dazu Toum und hausgemachte Soße im Baguette.', price: '8,90 €' },
          { num: '69', name: 'Nawfal XXL Wrap 🌶️', allergens: 'Allergene: A, C, G, K, L', desc: 'Extra großer Wrap mit zwei pikant gewürzten Hackfleischspießen aus Kalb und Lamm, gegrillter Aubergine, Batata Harra, Tomaten, Zwiebeln und eingelegten Gurken, dazu Toum, scharfe Soße und hausgemachte Soße. Auf Wunsch extra scharf 🌶️🌶️. „Nawfal sagt: Wenn’s noch zugeht, passt noch was rein.“', price: '14,90 €' }
        ]
      }
    ]
  },
    ...
    categories: [
      {
        ...
        items: [
          ...
          { num: '72', name: 'Falfouli Wrap 🥬', badge: '★ BELIEBT', allergens: 'Allergene: A, C, G, I, K, L', desc: 'Hausgemachte Falafeln mit gegrillter Aubergine, Pommes, Tomaten, eingelegten Gurken, weißen Rüben und Hummus, dazu hausgemachte Soße im Wrap.', price: '8,90 €' },
    ...
    categories: [
      {
        ...
        items: [
          ...
          { num: '92', name: 'Orient Burger 🌶️', badge: '★ BELIEBT', allergens: 'Allergene: A, C, G, J', desc: '160-g-Patty aus würzigem Kalb- und Lammhackfleisch mit Cheddar, Salat, Tomaten, Zwiebeln und eingelegten Gurken, dazu Toum und Burgersoße. Serviert mit Pommes, gemischtem Salat und cremigem Weißkohlsalat.', price: '15,90 €' },
    ...
    categories: [
      {
        ...
        items: [
          { num: '110', name: 'Qas Arabi Teller', badge: '★ BELIEBT', allergens: 'Allergene: A, C, G, K, L', desc: 'Gegrilltes Kalbfleisch mit Pommes, eingelegten Gurken und Toum im arabischen Fladenbrot, knusprig gegrillt und mit Granatapfelsirup verfeinert, in Stücke geschnitten und mit Pommes, gemischtem Salat, cremigem Weißkohlsalat, Hummus und Toum serviert.', price: '14,90 €' },
          { num: '111', name: 'Schawarma Arabi Teller', badge: '★ BELIEBT', allergens: 'Allergene: A, C, G, K, L', desc: 'Hähnchen-Schawarma vom Drehspieß mit Pommes, eingelegten Gurken und Toum im arabischen Fladenbrot, knusprig gegrillt und mit Granatapfelsirup verfeinert, in Stücke geschnitten und mit Pommes, gemischtem Salat, cremigem Weißkohlsalat, Hummus und Toum serviert.', price: '13,90 €' },
          ...
          { num: '117', name: 'Mamas Teller', badge: '★ BELIEBT', allergens: 'Allergene: A, C, G, H, I, K, L', desc: 'Gegrillte Hähnchenbrust, serviert mit orientalisch gewürztem Reis, gerösteten Nüssen, Berberitzen und frischer Petersilie, dazu gemischter Salat, Hummus, Toum, Muhammara und Rote-Bete-Creme.', price: '18,90 €' }
        ]
      }
    ]
  },
    ...
    categories: [
      {
        ...
        items: [
          ...
          { num: '131', name: 'Nawar Teller 🌶️', badge: '★ BELIEBT', allergens: 'Allergene: A, C, I, K, L', desc: 'Zwei pikant gewürzte Hackfleischspieße aus Kalb und Lamm, wahlweise mit Reis oder Pommes, dazu gemischter Salat, Hummus, Toum, Muhammara und Rote-Bete-Creme.', price: '18,90 €' },
          ...
          { num: '135', name: 'Alsafi Mix Teller', allergens: 'Allergene: A, C, I, K, L', desc: 'Ein gegrillter Kalbspieß, ein marinierter Hähnchenbrustspieß, ein Hackfleischspieß aus Kalb und Lamm und Hähnchen-Schawarma vom Drehspieß, wahlweise mit Reis oder Pommes, dazu gemischter Salat, Hummus, Toum, Muhammara und Rote-Bete-Creme.', price: '24,90 €' },
          { num: '136', name: 'Alsafi Mix Platte für 2 Personen', allergens: 'Allergene: A, C, I, K, L', desc: 'Zwei gegrillte Kalbspieße, zwei marinierte Hähnchenbrustspieße, zwei Hackfleischspieße aus Kalb und Lamm und Hähnchen-Schawarma vom Drehspieß, serviert mit Reis und Pommes, wahlweise Fattoush oder Tabbouleh, dazu Hummus, Toum, Muhammara und Rote-Bete-Creme.', price: '49,90 €' }
        ]
      },
      {
        id: 'c13',
  ...
  },
  {
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          { num: '170', name: 'Baklava', allergens: 'Allergene: A, G, H', desc: 'Orientalische Süßspeise aus feinem Blätterteig mit Nüssen und aromatischem Zuckersirup.', price: '3,90 €' },
          { num: '171', name: 'Kunafe', badge: '★ BELIEBT', allergens: 'Allergene: A, G, H', desc: 'Orientalische Süßspeise aus feinem Fadenteig mit geschmolzenem Mozzarella, aromatischem Zuckersirup und Pistazien.', price: '6,90 €' }
        ]
      }
    ],
    bottomCallout: {
    ...
    categories: [
      {
        ...
        items: [
          ...
          { num: '', name: 'Ayran, 0,25 l', allergens: 'Allergene: G', desc: '', price: '2,50 €' },
          ...
          { num: '', name: 'Radler alkoholfrei, 0,33 l', allergens: 'Allergene: A', desc: '', price: '3,80 €' },
          { num: '', name: 'Bier alkoholfrei, 0,33 l', allergens: 'Allergene: A', desc: '', price: '3,80 €' },
          { num: '', name: 'Capri-Sun, 0,2 l', allergens: 'Zusatzstoffe: 3', desc: '', price: '2,30 €' }
        ]
      },
      {
        id: 'c16',
